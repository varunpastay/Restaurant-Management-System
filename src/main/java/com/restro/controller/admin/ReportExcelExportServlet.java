...
import com.restro.utility.ExcelReportUtil;
...
@WebServlet(name = "ReportExcelExportServlet", urlPatterns = {"/admin/reports/export/excel"})
public class ReportExcelExportServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.setHeader("Content-Disposition", "attachment; filename=\"sales-report-" + period + ".xlsx\"");
            ExcelReportUtil.generate(response.getOutputStream(), restaurant, period, totalRevenue, orderCount, avgOrderValue,
            ...
            throw new ServletException("Failed to export Excel report", e);
        }
    }
}
